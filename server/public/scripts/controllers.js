            ...
            for (var l in $scope.dd.genres){
                $scope.dd.genres[l].summ = 0;
                    ...
                    for(var m in $scope.dd.genres[l].titles){
                        $scope.dd.genres[l].summ += ($scope.dd.genres[l].titles[m].scoreOfOne*$scope.dd.genres[l].titles[m].epsInOne)/$scope.dd.genres[l].episodes;
                        console.log('eeerr');
                    };
                 };
            for(var i in $scope.dd.anime){
             ...
             for (var j in $scope.dd.genres){
                ...
                $scope.dd.genres[j].weightedScore = $scope.dd.genres[j].summ/$scope.dd.genres[j].count;
